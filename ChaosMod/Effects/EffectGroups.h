...
inline std::unordered_map<std::string, EffectGroupData> g_dictEffectGroups {
	{ "_group_teleport", { .WeightMult = 10 } },          { "_group_spawngeneric", { .WeightMult = 20 } },
	{ "_group_spawnenemyspecial", { .WeightMult = 10 } }, { "_group_spawnenemy", { .WeightMult = 15 } },
	{ "_group_spawncompanion", { .WeightMult = 10 } },    { "_group_weapons", { .WeightMult = 5 } },
