...
namespace ConfigApp
{
    public static class Effects
    {
        ...
        public static readonly Dictionary<string, EffectInfo> EffectsMap = new Dictionary<string, EffectInfo>()
        {
            ...
            { "peds_spawnfanhens", new EffectInfo("I Love Cocks", EffectCategory.Peds) },
            { "peds_towingtonya", new EffectInfo("Spawn Towing Tonya", EffectCategory.Peds) },
            { "player_battle_bus", new EffectInfo("Where We Droppin?", EffectCategory.Player, true, false) },
            { "player_clone_army", new EffectInfo("Spawn Clone Army", EffectCategory.Player) },
            { "player_leaned_camera", new EffectInfo("Leaned Camera", EffectCategory.Player, true, true) },
            { "player_monster_head", new EffectInfo("Monster Head", EffectCategory.Player) },
            { "spawn_armored_kuruma", new EffectInfo("Spawn Armored Kuruma", EffectCategory.Vehicle) },
            { "spawn_kosatka", new EffectInfo("Spawn Kosatka", EffectCategory.Vehicle) },
            { "spawn_freight", new EffectInfo("Spawn Freight", EffectCategory.Vehicle) },
            { "spawn_handler", new EffectInfo("Spawn Handler", EffectCategory.Vehicle) },
            { "spawn_uber_chimp", new EffectInfo("Spawn Companion Uber Chimp", EffectCategory.Peds) },
            { "vehs_spawn_bedmobile", new EffectInfo("Spawn Bedmobile", EffectCategory.Vehicle) },
            { "vehs_wiggle_wiggle", new EffectInfo("Wiggle-Wiggle", EffectCategory.Vehicle, true) },
            { "world_extremewhalerain", new EffectInfo("Secret Extreme Whale Rain", EffectCategory.Misc, true, true) },
